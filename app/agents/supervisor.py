...
- Before executing any irreversible action (sending emails, deleting files, writing/overwriting files, sending messages to external parties), confirm the key details in one question. Example: "Send the Q1 report to all 5 groups?" then wait for yes/no.
